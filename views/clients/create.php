...
<div class="container">
    <div class="row justify-content-md-center">
        <div class="col-md-6">
            ...
            <div class="mb-5"></div>
            <form id="create" name="create" action="/clients/createconfirm" method="post">
                ...
                <div class="form-group text-center">
                    <?php Form::Input( $models->Validations[ 'Confirme' ], $models->Confirme ) ?>
                    <?php Form::Label( $models->Validations[ 'Confirme' ] ) ?>
                </div>
                <div class="form-group text-center">
                    <?php Form::Input( $models->Validations[ 'Admin' ], $models->Admin ) ?>
                    <?php Form::Label( $models->Validations[ 'Admin' ] ) ?>
                </div>
